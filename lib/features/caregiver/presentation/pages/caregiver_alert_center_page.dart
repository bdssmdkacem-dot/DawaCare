...
class CaregiverAlertCenterPage extends StatelessWidget {
  ...
  Future<void> _openAlert(BuildContext context, CaregiverAlert alert) async {
    ...
    final link = provider.linkedPatients.cast<dynamic?>().firstWhere(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(_tr(context, 'مركز التنبيهات والرعاية', 'Care & Alerts', 'Centre des alertes')),
      ),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              _tr(context, 'لا توجد تنبيهات تحتاج إلى تدخل الآن.', 'No alerts need your attention right now.', 'Aucune alerte ne nécessite votre intervention.'),
  ...
  Widget _summary(BuildContext context, CaregiverProvider provider) {
    ...
    return Card(
      child: Padding(
        ...
        child: Row(
          children: [
            _metric(context, Icons.warning_amber_rounded, '$unread', _tr(context, 'غير مقروء', 'Unread', 'Non lues')),
            _divider(),
  ...
  Widget _metric(BuildContext context, IconData icon, String value, String label) => Expanded(
        child: Column(
          children: [
            ...
            Text(label, textAlign: TextAlign.center, maxLines: 2, overflow: TextOverflow.ellipsis, style: Theme.of(context).textTheme.bodySmall),
          ],
        ),
      );
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              Expanded(child: Text('$title (${alerts.length})', style: const TextStyle(fontWeight: FontWeight.w900, fontSize: 16))),
            ],
          ),
        ),
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        if (!alert.read) Container(width: 8, height: 8, decoration: const BoxDecoration(shape: BoxShape.circle, color: AppColors.primary)),
                      ],
                    ),
