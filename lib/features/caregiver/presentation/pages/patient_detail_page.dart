  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: p.isLoading && p.all.isEmpty
          ...
          : RefreshIndicator(
              onRefresh: () => context.read<DoseProvider>().load(
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    _tr(context, 'أرسل رسالة صوتية عامة لهذا الشخص.', 'Send a general voice message to this person.', 'Envoyez un message vocal général à cette personne.'),
                                    style: Theme.of(context).textTheme.bodySmall,
                                  ),
                                ],
                              ),
