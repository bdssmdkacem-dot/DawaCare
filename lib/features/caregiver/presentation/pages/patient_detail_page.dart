  ...
  Widget _doseCard(BuildContext providerContext, DoseInstance dose) {
    ...
    return Padding(
      ...
      child: DoseCard(
        ...
        onConfirm: _canManageDoses ? () => doseProvider.confirm(dose, source: 'CAREGIVER') : null,
        onSnooze: _canManageDoses ? () => doseProvider.snooze(dose, source: 'CAREGIVER') : null,
        onSkip: _canManageDoses ? () => doseProvider.skip(dose, source: 'CAREGIVER') : null,
      ),
    );
  }
