              ...
              FutureBuilder<String?>(
                ...
                builder: (context, snapshot) {
                  ...
                  return Container(
                    ...
                    child: image == null
                        ? const Icon(Icons.medication_liquid_rounded, color: AppColors.primary, size: 32)
                        : Image.network(image, fit: BoxFit.cover, errorBuilder: (_, __, ___) => const Icon(Icons.medication_liquid_rounded, color: AppColors.primary, size: 32)),
                  );
                },
              ),
